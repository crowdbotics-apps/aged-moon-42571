"""
Django settings for aged_moon_42571 project.
...
ROOT_URLCONF = 'aged_moon_42571.urls'
...
WSGI_APPLICATION = 'aged_moon_42571.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_moon_42571 API",
    "DESCRIPTION": "API documentation for aged_moon_42571 App",
    "VERSION": "v1",
}
